...
_PROFILE_DEFAULTS: dict[str, dict] = {
    ...
    "forge": {
        ...
        "cadence_interval_ns": 16_000_000_000,
        "rotation_windows": 7,
        "min_spread_ticks": 3.5,
        ...
        "inactive_book_frac": 0.05,
        "max_spread_ratio": 0.0011,
        "inventory_skew_soft": 0.002,
        "inventory_skew_hard": 0.005,
        "cold_book_volume_threshold": 350.0,
    ...
    "flux": {
        ...
        "min_rt_edge_ticks": 3.5,
        "min_quote_rt_edge_ticks": 4.0,
        "min_completion_rt_edge_ticks": 6.5,
        "min_microprice_edge_ticks": 0.8,
        "inside_depth_ticks": 1,
        "deep_spread_ticks": 7.0,
        "two_sided_wide_ticks": 6.0,
...
class AscendAgent(FinanceSimulationAgent):
    ...
    def respond(self, state: MarketSimulationStateUpdate) -> FinanceAgentResponse:
        ...
        ascend_score_tick(
            ...
            max_flatten_per_tick=int(getattr(self, "max_flatten_per_tick", 12)),
