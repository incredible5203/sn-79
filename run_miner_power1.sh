...
# run_miner_power1.sh — testnet turbo miner #1 (TurboPulseAgent)
#
# Fill in PM2_NAME, EXPECTED_UID, WALLET_NAME, HOTKEY_NAME, AXON_PORT before launch.

REPO_ROOT="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"

PM2_NAME=test-power243
EXPECTED_UID=243

ENDPOINT=wss://test.finney.opentensor.ai:443
WALLET_PATH=~/.bittensor/wallets/
WALLET_NAME=test-sub79
HOTKEY_NAME=hot1
NETUID=366
AXON_PORT=6101
AGENT_PATH=~/.taos/agents
AGENT_NAME=TurboPulseAgent
AGENT_PARAMS="lazy_load=1 turbo_profile=pulse min_quantity=0.28 max_quantity=0.46 quantity_scale=0.96 relative_threshold=0.00008 reversion_threshold=0.00012 cadence_interval_ns=20000000000 inventory_skew_soft=0.024 inventory_skew_hard=0.044 max_books_per_tick=12 book_rotation_groups=16 max_spread_ratio=0.0018 inactive_book_frac=0.30 max_two_sided_per_tick=6 max_instructions_per_book=4 max_total_instructions=30 max_fee_rate=0.002 expiry_period=180000000000"
LOG_LEVEL=info
