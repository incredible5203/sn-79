...
# run_miner_power6.sh — testnet turbo v2 miner #6 (TurboEdgeV2Agent)
#
...
AGENT_NAME=TurboEdgeV2Agent
AGENT_PARAMS="lazy_load=1 turbo_profile=edge min_quantity=0.28 max_quantity=0.44 quantity_scale=0.95 relative_threshold=0.00007 reversion_threshold=0.00010 cadence_interval_ns=22000000000 inventory_skew_soft=0.024 inventory_skew_hard=0.044 max_books_per_tick=10 book_rotation_groups=12 max_spread_ratio=0.0016 inactive_book_frac=0.26 max_two_sided_per_tick=2 max_instructions_per_book=4 max_total_instructions=24 max_fee_rate=0.002 expiry_period=180000000000 cancel_stale=1 max_cancel_per_book=2 max_requote_per_tick=4 min_fill_score=4.5 touch_join_on_requote=0 requote_ttl_ticks=6"
LOG_LEVEL=info
