...
AGENT_NAME=TurboEdgeAgent
AGENT_PARAMS="lazy_load=1 turbo_profile=edge min_quantity=0.28 max_quantity=0.44 quantity_scale=0.95 relative_threshold=0.00007 reversion_threshold=0.00010 cadence_interval_ns=22000000000 inventory_skew_soft=0.024 inventory_skew_hard=0.044 max_books_per_tick=10 book_rotation_groups=12 max_spread_ratio=0.0018 inactive_book_frac=0.28 max_two_sided_per_tick=2 max_instructions_per_book=4 max_total_instructions=22 max_fee_rate=0.002 expiry_period=180000000000"
LOG_LEVEL=info
